...
* Normal check in
* Normal renewal
* Check in of missing copy
* Check in of lost-and-paid copy
* Check in of damaged copy
* Check in of claims-returned copy
* Check in of long overdue copy
* Check in of claims-never-checked-out copy
* Check in of lost copy
...
* Normal check in at circ lib
* Normal renewal at circ lib
* Normal checkout at owning lib
* Normal check in at owning lib
...
.. _Next Status_: can be used with temporary Check In Alerts only. If a nextstatus is configured, staff will be presented with a list of statuses to choose from when the item is checked in.
